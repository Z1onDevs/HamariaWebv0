...
const therapyMatrix = [
  ...
  },
  {
    ...
    nameES: "Outdoor training (Retiro)",
    allocations: { longevity: "Unlimited", performance: "Unlimited", aesthetics: "Unlimited" },
  },
  {
    name: "Mindfulness",
  ...
  },
  {
    ...
    nameES: "Signature massages",
    allocations: { longevity: 0, performance: 0, aesthetics: 0 },
  },
  {
    name: "Liver cleansing IV",
    nameES: "Liver cleansing IV",
    allocations: { longevity: 0, performance: 0, aesthetics: 0 },
  },
  {
    name: "Photorejuvenation laser",
    nameES: "Láser fotorejuvenecedor",
    allocations: { longevity: 0, performance: 0, aesthetics: 0 },
  },
  {
    name: "Chemical peels",
    nameES: "Peelings químicos",
    allocations: { longevity: 0, performance: 0, aesthetics: 0 },
  },
  {
    name: "Nutrition protocols",
    nameES: "Nutrition protocols",
    allocations: { longevity: 1, performance: "Unlimited", aesthetics: "Unlimited" },
    isYearly: true,
  },
  {
    name: "Supplementation protocols",
    nameES: "Supplementation protocols",
  ...
  },
  {
    ...
    allocations: { longevity: "Optional", performance: "Optional", aesthetics: "Optional" },
    isYearly: true,
  },
  {
  ...
  {
    name: "Hormone panel (TSH, T3, T4, cortisol, IGF-1, sex hormones)",
    nameES: "TSH, T3, T4; cortisol; IGF-1; hormonas sexuales",
    allocations: { longevity: 1, performance: 1, aesthetics: 1 },
    isYearly: true,
  },
  {
    name: "Micronutrient panel (Vit D, B12, folate, minerals)",
    nameES: "Vitamina D, B12, folato; magnesio, calcio, zinc, selenio, cobre, hierro",
    allocations: { longevity: 1, performance: 1, aesthetics: 1 },
    isYearly: true,
  },
  {
  ...
  {
    name: "Metabolic panel (glucose, insulin, HbA1c)",
    nameES: "Glucosa, insulina, HbA1c",
    allocations: { longevity: 0, performance: 0, aesthetics: 0 },
    isYearly: true,
  },
] satisfies Array<{
